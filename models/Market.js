...
const itemSchema = new mongoose.Schema({
    ...
    type: {
        type: String,
        required: true,
        enum: ["skins", "skills", "goldpacks", "crystalpacks", "chests", "freebie", "weapon"]
    },
    ...
    inventorytype: {
        type: String,
        required: true,
        enum: ["weapon", "outfit", "hair", "face", "eyes", "skills", "skincolor", "skins", "goldpacks", "crystalpacks", "chests", "freebie"]
    },
    gender: {
        type: String,
        required: true,
